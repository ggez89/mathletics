...
export const ProblemRenderer: React.FC<ProblemRendererProps> = ({ problem, showAnswers, number }) => {
  ...
  return (
    <div className={`flex ${format === "inline" ? "items-center" : "items-start"} gap-2 ${format === "longDivision" ? "py-2 print:py-3" : "py-2 print:py-2"} px-2 border border-transparent hover:border-gray-100 transition-colors`}>
